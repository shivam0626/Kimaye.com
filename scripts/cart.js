...
var cartData = JSON.parse(localStorage.getItem("kimaye-cart"))||[];
...
function removeItem(elem, index) {
    ...
    console.log(cartData);
    localStorage.setItem("kimaye-cart", JSON.stringify(cartData));
    window.location.reload();
...
//    function cartpage(){
//    console.log("in kimaye-cart")
//    window.location.href="kimaye-cart.html"
// }

let savearr =JSON.parse(localStorage.getItem("saveltr1"))  || [];

function addtoSavelater(elem){
  savearr.push(elem);
  localStorage.setItem("saveltr1",JSON.stringify(savearr));
  console.log(elem);
}

let later = JSON.parse(localStorage.getItem("saveltr1"));
